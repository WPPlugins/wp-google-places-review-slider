...
<tr class="wprevpro_row">
				...
				?>
					...
					<p class="description">
					<?php _e('More styles available in <a href="?page=wp_fb-get_pro">Pro Version</a> of plugin!', 'wp-google-reviews'); ?></p>
				</td>
			</tr>
			<tr class="wpfbr_row">
				<th scope="row">
			...
			<tr>
				<td class="notice updated " colspan="2" style="border-left: 4px solid #d6d6d6;">
					<p><strong><?php _e('Upgrade to the Pro Version of this plugin to access more super cool settings! <a href="#TB_inline?tempnum=1&inlineId=mythickboxid&height=650&width=1030" class="thickbox">(Screenshot)</a> Get the Pro Version <a href="?page=wp_fb-get_pro">here</a>!', 'wp-google-reviews'); ?></strong></p>
				</td>
			</tr>
